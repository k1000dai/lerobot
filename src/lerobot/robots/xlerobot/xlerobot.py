...
class XLerobot(Robot):
    ...
    def __init__(self, config: XLerobotConfig):
        ...
        self.bus1 = FeetechMotorsBus(
            ...
            motors={
                # left arm
                "arm_shoulder_pan_l": Motor(1, "sts3215", norm_mode_body),
                "arm_shoulder_lift_l": Motor(2, "sts3215", norm_mode_body),
                "arm_elbow_flex_l": Motor(3, "sts3215", norm_mode_body),
                "arm_wrist_flex_l": Motor(4, "sts3215", norm_mode_body),
                "arm_wrist_roll_l": Motor(5, "sts3215", norm_mode_body),
                "arm_gripper_l": Motor(6, "sts3215", MotorNormMode.RANGE_0_100),
                # head
        ...
        self.bus2= FeetechMotorsBus(
            ...
            motors={
                # right arm
                "arm_shoulder_pan_r": Motor(1, "sts3215", norm_mode_body),
                "arm_shoulder_lift_r": Motor(2, "sts3215", norm_mode_body),
                "arm_elbow_flex_r": Motor(3, "sts3215", norm_mode_body),
                "arm_wrist_flex_r": Motor(4, "sts3215", norm_mode_body),
                "arm_wrist_roll_r": Motor(5, "sts3215", norm_mode_body),
                "arm_gripper_r": Motor(6, "sts3215", MotorNormMode.RANGE_0_100),
                # base
